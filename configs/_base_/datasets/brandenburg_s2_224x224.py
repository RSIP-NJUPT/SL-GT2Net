...
data_root = r"data/brandenburg/s2_2020_2021"
# two channels, i.e., dual polarization (VV+VH)
img_norm_cfg_trainval = dict(mean=[-16.54, -10.91], std=[3.07, 2.89], to_rgb=False)
img_norm_cfg_test = dict(mean=[-16.54, -10.91], std=[3.07, 2.89], to_rgb=False)
