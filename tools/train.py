...
def parse_args():
    ...
    # parser.add_argument(
    #     "--config", default=r"configs/slgt2/isa_224x224_40k_slovenia.py", help="train config file path"
    # )
    parser.add_argument("--work-dir", help="the dir to save logs and models")
    parser.add_argument("--load-from", help="the checkpoint file to load weights from")
    parser.add_argument("--resume-from", help="the checkpoint file to resume from")
    # parser.add_argument("--resume-from", default=r'work_dirs/slgt2_224x224_40k_brandenburg_s2/train_20240529_060354/iter_28000.pth', help="the checkpoint file to resume from")
    parser.add_argument(
